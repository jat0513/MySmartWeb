...
import com.smartmvc.helper.ConfigHelper;
import com.smartmvc.helper.ControllerHelper;
import com.smartmvc.util.*;
...
public class DispatherServlet extends HttpServlet {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(DispatherServlet.class);
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        LOGGER.info("accept request:requestMethod={},requestPath={}", requestMethod, requestPath);
